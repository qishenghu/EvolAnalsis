...
| 2026-05-02 14:46 | L20X    | RESTART_v2              | — | — | Killed pk07_v00 mid-training (step 50, v1). Archived pk05_v00 v1 result (27.0%) as `*_v1latched`, pk07_v00 partial as `*_v1partial`. Launched fresh `run_l20x_velocity_v2.sh` queue: pk03_v00_K15 → pk05_v00 → pk07_v00 → pk05 → pk03_aggr (5 × 3.5h ≈ 17.5h). All 5 use v2 triple-gated latch via fresh launcher.py → on-disk het_actor.py. ETA ~08:20 next day. |
