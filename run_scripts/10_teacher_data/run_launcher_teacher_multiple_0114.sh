...
python launcher.py \
  --conf config/alfworld_grpo_3b_teacher_only_no_logprob__baseline_sep_plus_token_gate.yaml
...
python launcher.py \
  --conf config/alfworld_grpo_3b_teacher_only_no_logprob__token_gate_only.yaml
