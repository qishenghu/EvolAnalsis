...
|------|------|----------|-------|-------|------|--------|------|
| ALFWorld | Qwen2.5-1.5B | ⬚ 待跑 | ⬚ 待跑 | ⬚ 待跑 | ⬚ 待跑 | ⬚ 待跑 | **优先** |
| ALFWorld | Qwen2.5-3B | ✅ 已完成 | ✅ 已完成 | ❌ 需重跑 | ✅ 已完成 | ⬚ 待跑 | 缺 CHORD, SFT+RL |
| WebShop | Qwen2.5-1.5B | ⬚ 待跑 | ⬚ 待跑 | ⬚ 待跑 | ⬚ 待跑 | ⬚ 待跑 | **优先** |
| WebShop | Qwen2.5-3B | ✅ 已完成 | ✅ 已完成 | ✅ 已完成 | ✅ 已完成 | ⬚ 待跑 | 缺 SFT+RL |
