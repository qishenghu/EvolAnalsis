...
python launcher.py \
  --conf config/alfworld_grpo_3b_teacher_only_no_logprob.yaml


python launcher.py \
  --conf config/alfworld_grpo_3b_teacher_only_use_logprob.yaml

python launcher.py \
  --conf config/alfworld_grpo_3b_teacher_only_use_logprob_random.yaml
